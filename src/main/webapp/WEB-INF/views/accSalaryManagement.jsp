...
<div class="container">
    ...
    <div id="main-view" >
        <div>
            <form  action="/acc/search" method="get" style=""  class="form-styles" >

                <label for="username">Username:</label>
                <input type="text" id="username" name="username" /><br>

                <label for="workStatus">Work Status:</label>
                <select class="custom-select" id="workStatus" name="workStatus" >
                ...
                <label for="minAttendance">Min Attend:</label>
                <input type="number" id="minAttendance" name="minAttendance" required/><br>

                <label for="maxAttendance">Max Attend</label>
                <input type="number" id="maxAttendance" name="maxAttendance" required/><br>
            ...
            <c:forEach var="user" items="${userList}">
                <tr>
                    ...
                    <td>
                        ...
                        <form method="post" action="/acc/user_echo/${user.id}" style="display:inline;">
