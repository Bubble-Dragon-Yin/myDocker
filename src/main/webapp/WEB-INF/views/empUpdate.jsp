...
<div class="container">
    <div id="main-form-view">
        <h2>  User Update </h2>
        <form action="/admin/user_update/${userId}" method="post" style="height: auto" class="form-styles" id="userForm">
            ...
            <input type="hidden" id="profilePhotoUrl" name="profilePhoto" value="${profilePhoto}" required/><br>
            ...
            <select class="custom-select" id="sportStatus" name="sportStatus" required>
                ...
                <option value="YES" ${sportStatus == "YES" ? 'selected' : ""}>YES</option>
            </select>
